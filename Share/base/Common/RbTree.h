...
/*
 * This is a red blank tree(RBTree) implementation. The codes below are learn from gcc library, but
 * reduce some unnecessary content. In tmq, we will take all advantages of the RBTree to do the
 * address reuse in the allocating of linear space during the persistent implementation.
 */
...
TMQSize RbTree<T1, T2>::Size() const {
    return size;
}
